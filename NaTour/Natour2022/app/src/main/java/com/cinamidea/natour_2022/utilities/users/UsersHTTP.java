package com.cinamidea.natour_2022.utilities.users;
...
public class UsersHTTP {
    ...
    public static void putProfileImage(String user_type, String image_base64, String username, String id_token, HTTPCallback callback) {
    ...
    public static void getProfileImage(String user_type, String username, String id_token, HTTPCallback callback) {
