...
public class GetFavouritesCallback implements HTTPCallback {
    ...
    public GetFavouritesCallback(Activity activity, ProgressBar progressBar, ArrayList<Route> routes, ArrayList<Route> fav_routes, RecyclerView recyclerView, RecyclerViewAdapter recyclerViewAdapter) {
        this.activity = activity;
        this.progressBar = progressBar;
        this.fav_routes = fav_routes;
        this.routes = routes;
        ...
        activity.runOnUiThread(() -> {
            ...
            if(!is_search) {
                ...
                if(recyclerView == null) {
                    ...
                    fav_routes = jsonToRoutesParsing(response);
                    SearchActivity.recyclerViewAdapter = new RecyclerViewAdapter(activity, routes, jsonToRoutesParsing(response), false);
                    SearchActivity.recyclerView.setAdapter(SearchActivity.recyclerViewAdapter);
